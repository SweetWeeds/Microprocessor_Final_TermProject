...
void InitFormatTable() {
    ...
    BYTE_SIZE_TABLE[GROUP_BUFFER][CMD_CLASS_CONTROL][CMD_BUFFER_CTRL_ADD_MULTI] = D10;
    BYTE_SIZE_TABLE[GROUP_BUFFER][CMD_CLASS_CONTROL][CMD_BUFFER_CTRL_PRINT] = D1;
    BYTE_SIZE_TABLE[GROUP_BUFFER][CMD_CLASS_UPDATE][CMD_BUFFER_UPDATE_PRINT] = D16;
    BYTE_SIZE_TABLE[GROUP_BUFFER][CMD_CLASS_CONTROL][CMD_BUFFER_CTRL_DEL] = D1;
}
