...
char BYTE_SIZE_TABLE[3][2][5];	// BYTE_SIZE_TABLE[GROUP_NUM][CMD_CLASS][CMD_NUM] = DATA_FORMAT
...
void InitFormatTable() {
	...
	// BUFFER
	BYTE_SIZE_TABLE[GROUP_BUFFER][CMD_CLASS_UPDATE][CMD_BUFFER_CTRL_FILL] = D10;
